...
import com.example.app_banhang.activity.DanhgiaActivity;
import com.example.app_banhang.activity.LSMHActivity;
...
public class LSMHAdapter extends RecyclerView.Adapter<LSMHAdapter.ItemHolder> {
    ...
    public LSMHAdapter(Context context, ArrayList<sanpham> arraysanpham) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.dong_lichsumuahang,null);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder{
        ...
        public ItemHolder( View itemView){
            super(itemView);
            imgsanpham = (ImageView) itemView.findViewById(R.id.imageviewlsmh);
            txtgiasp = (TextView) itemView.findViewById(R.id.textviewgiatrimonhang);
            txttensp =(TextView) itemView.findViewById(R.id.textviewtengiohang);
