...
public class sanpham_lsp_Adapter extends RecyclerView.Adapter<sanpham_lsp_Adapter.ItemHolder> {
    static Context context;
    static ArrayList<sanpham> arraysanpham;

    public sanpham_lsp_Adapter(Context context, ArrayList<sanpham> arraysanpham) {
